...
const BottomHeader = () => {
  return (
    <div className="relative w-screen h-screen z-10 bg-fixed flex items-center justify-center"
      style={{
    ...
    >
      <img src={logo} className='w-1/2 md:w-[500px]' data-aos='fade-up' data-aos-duration="2000" alt="" />
    </div>
  )
}
